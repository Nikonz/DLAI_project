...
# https://github.com/adambielski/pytorch-gconv-experiments/blob/master/cifar10/models/resnet.py #
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, in_channels=3):
        ...
        self.conv1 = P4MConvZ2(in_channels, 23, kernel_size=3, stride=1, padding=1, bias=False)
